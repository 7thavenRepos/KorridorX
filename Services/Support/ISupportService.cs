...
public interface ISupportService
{
    ...
    Task<SupportEvidenceDto> AddTicketEvidenceAsync(Guid userId, Guid ticketId, AddSupportEvidenceRequestDto request, CancellationToken ct = default);
    ...
    Task<SupportEvidenceDto> AddDisputeEvidenceAsync(Guid userId, Guid disputeId, AddSupportEvidenceRequestDto request, CancellationToken ct = default);
}
